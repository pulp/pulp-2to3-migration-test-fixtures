...
# these are the changes to the rpm_base_4repos_rerun_changes shapshot
pulp-admin rpm repo create --repo-id rpm-with-modules-copy
pulp-admin rpm repo copy all --from-repo-id rpm-with-modules --to-repo-id rpm-with-modules-copy


mkdir rpm_base_4repos_rerun_copy
cd rpm_base_4repos_rerun_copy
mongodump --archive=mongodb.rpm_base_4repos_rerun_copy.archive --db=pulp_database
sudo -u apache tar -zcvf pulp2_var_lib_published.rpm_base_4repos_rerun_copy.tar.gz  /var/lib/pulp/published
sudo -u apache tar -zcvf pulp2_var_lib_content.rpm_base_4repos_rerun_copy.tar.gz  /var/lib/pulp/content
tar -xvf pulp2_var_lib_published.rpm_base_4repos_rerun_copy.tar.gz
tar -xvf pulp2_var_lib_content.rpm_base_4repos_rerun_copy.tar.gz
rm pulp2_var_lib_published.rpm_base_4repos_rerun_copy.tar.gz
rm pulp2_var_lib_content.rpm_base_4repos_rerun_copy.tar.gz
